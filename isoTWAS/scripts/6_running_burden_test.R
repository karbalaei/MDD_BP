...
gwas <- fread(here("twas/hg38" , "PGC_UKB_23andMe_depression_genome-wide_isotwas_hg38.txt"))
...
save(out_df , file = here("isotwas" , "Results" , paste0(opt$region,"_BurdenTest_results_MDD.RDS")))

write.table(out_df, file = here("isotwas" , "Results" , paste0(opt$region,"_BurdenTest_results_MDD.txt")), sep = "\t", row.names = FALSE, quote = FALSE)
