...
load(file = here("results" ,"BP_MDD_All_results_Micheal_method_Final.RDS"))
...
signif_genes_af <- transpose(signif_genes_all)
...
walk2(names(all_plots), all_plots, ~ggsave(filename = here("graphs" , "Enrichment results" , "all" , paste0(.x , "_Micheal_method.jpg")), plot = .y, 
                                             height = 14, width = 9))



pdf(here("graphs"  , "Enrichment results" , "all" , "Enrichment results MDD vs. BP_Micheal_method.pdf") , height = 14 , width = 9)

map2(Enrichment_results, names(Enrichment_results), ~dotplot(.x, title = .y , showCategory = 25))

dev.off()

save(Enrichment_results,file = here("results", "enrichGO_All_Micheal_method.rda"))
...
walk2(names(all_plots_up), all_plots_up, ~ggsave(filename = here("graphs" , "Enrichment results" , "up" , paste0(.x , "_Micheal_method.jpg")), plot = .y, 
                                             height = 14, width = 9))




pdf(here("graphs" , "Enrichment results" , "up" , "Enrichment results MDD vs. BP_up_Micheal_method.pdf") , height = 14 , width = 9)
...
save(Enrichment_results_up,file = here("results", "enrichGO_up_Micheal_method.rda"))
...
walk2(names(all_plots_down), all_plots_down, ~ggsave(filename = here("graphs" , "Enrichment results" , "down" , paste0(.x , "_Micheal_method.jpg")), plot = .y, 
                                             height = 14, width = 9))




pdf(here("graphs" , "Enrichment results" , "down"  , "Enrichment results MDD vs. BP_down_Micheal_method.pdf") , height = 14 , width = 9)
...
save(Enrichment_results_down,file = here("results", "enrichGO_down_Micheal_method.rda"))
