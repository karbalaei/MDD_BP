...
BP_MDD_Gene_Final<- map2(rse_gene_sep, modSep, ~run_DE(rse = .x, model = .y, coef = "PrimaryDxBipolar" , save_eBayes = TRUE))

save(BP_MDD_Gene_Final, file = here("results" , "BP_MDD_Gene_qSV_test.Rdata"), compress=TRUE)
...
BP_MDD_Exon_Final<- map2(rse_sep_exon, modSep, ~run_DE(rse = .x, model = .y, coef = "PrimaryDxBipolar" , save_eBayes = TRUE))
save(BP_MDD_Exon_Final, compress = TRUE, file = here("results" , "BP_MDD_Exon_qSV_test.Rdata"))
...
BP_MDD_Junction_Final<- map2(rse_sep_jxn, modSep, ~run_DE(rse = .x, model = .y, coef = "PrimaryDxBipolar" ,  save_eBayes = TRUE))
save(BP_MDD_Junction_Final, file = here("results" ,"BP_MDD_Junction_qSV_test.Rdata"))
...
BP_MDD_Transcript_Final<- map2(rse_sep_tx, modSep, ~run_DE(.x, .y, run_voom = FALSE, coef = "PrimaryDxBipolar" , save_eBayes = TRUE))
save(BP_MDD_Transcript_Final, compress=TRUE, file = here("results" ,"BP_MDD_Transcript_qSV_test.Rdata"))
...
Outlist_test <-  list("gene" = BP_MDD_Gene_Final, "exon" = BP_MDD_Exon_Final, "jxn" = BP_MDD_Junction_Final ,"tx" = BP_MDD_Transcript_Final)


save(Outlist_test , file = here("results", "BP_MDD_All_results_test.RDS"))
