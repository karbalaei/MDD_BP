...
save(BP_MDD_Gene_Final, file = here("results" , "BP_MDD_Gene_qSV_test23.Rdata"), compress=TRUE)
...
save(BP_MDD_Exon_Final, compress = TRUE, file = here("results" , "BP_MDD_Exon_qSV_test23.Rdata"))
...
save(BP_MDD_Junction_Final, file = here("results" ,"BP_MDD_Junction_qSV_test23.Rdata"))
...
save(BP_MDD_Transcript_Final, compress=TRUE, file = here("results" ,"BP_MDD_Transcript_qSV_test23.Rdata"))
...
Outlist_test23 <-  list("gene" = BP_MDD_Gene_Final, "exon" = BP_MDD_Exon_Final, "jxn" = BP_MDD_Junction_Final ,"tx" = BP_MDD_Transcript_Final)


save(Outlist_test23 , file = here("results", "BP_MDD_All_results_test23.RDS"))
