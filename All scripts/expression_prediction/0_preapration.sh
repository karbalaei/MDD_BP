...
find ./out_files -type f -name "*.wgt.RDat" -exec basename {} \; > ./Amygdala_exp_pred_gene_list.txt
...
split -l 5000 --numeric-suffixes=1 --suffix-length=1 --additional-suffix=.txt ./Amygdala_exp_pred_gene_list.txt ./Amygdala_exp_pred_gene_list_

cd ../sACC_gene

find ./out_files -type f -name "*.wgt.RDat" -exec basename {} \; > ./sACC_exp_pred_gene_list.txt
...
split -l 5000 --numeric-suffixes=1 --suffix-length=1 --additional-suffix=.txt ./sACC_exp_pred_gene_list.txt ./sACC_exp_pred_gene_list_
