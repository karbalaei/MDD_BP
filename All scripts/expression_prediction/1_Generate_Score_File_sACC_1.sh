...
#SBATCH -p shared
#SBATCH --mem=1G
#SBATCH --job-name=compute_score_file_sACC_full_gene_1
#SBATCH -c 1
#SBATCH -o ../twas/logs/predict_expression/score_file/compute_score_file_sACC_full_gene_1_%a_O.txt
#SBATCH -e ../twas/logs/predict_expression/score_file/compute_score_file_sACC_full_gene_1_%a_E.txt
...
FILELIST="/dcs04/lieber/lcolladotor/hydeGoes_LIBD3010/hydeGoes_scSeq_mdd/MDD_vs_BP/twas/sACC_gene/sACC_exp_pred_gene_list_1.txt"
