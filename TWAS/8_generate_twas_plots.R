...
pdf(file = here::here("twas", "analysis", "plots", "MDD_BPTWAS_ManhattanPlot.pdf"))
...
pdf(
    'analysis/plots/MDD_BP_TWAS_ScatterPlots_hsqFail.pdf',
    useDingbats = FALSE,
    width = 10,
    height = 10
)
...
pdf(
    'analysis/plots/MDD_BP_TWAS_Z_Correlation.pdf',
    useDingbats = FALSE,
    width = 10,
    height = 10
)
...
write.xlsx2(
    ...
    file = "analysis/tables/MDD_BP_Amyg_sACC_FinalOutputTable.xlsx",
