...
do
    ...
    do
        ...
        do
            ...
            SHORT="6_apply_weights_full_${region}_${feature}_${summstats}"
...
if [ "${summstats}" == "pgc" ]
then
    summstatsfile="/dcs04/lieber/lcolladotor/hydeGoes_LIBD3010/hydeGoes_scSeq_mdd/MDD_vs_BP/twas/hg38/PGC_UKB_23andMe_depression_genome-wide_CLEAN_hg38.txt"
else
