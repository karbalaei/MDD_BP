...
spec <- matrix(c(
    ...
    "cores", "c", 10, "integer", "Number of cores to use. Use a small number",
...
#write.table(rdat_files, file = "wglist_summary.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)

#/jhpce/shared/libd/core/fusion_twas/github/fusion_twas-master/utils/FUSION.profile_wgt.R# Rscript /jhpce/shared/jhpce/libd/fusion_twas/github/fusion_twas/utils/FUSION.profile_wgt.R Amygdala_gene.list > Amygdala_gene.profile.err 2>&1
system(paste0("Rscript /dcs04/lieber/lcolladotor/hydeGoes_LIBD3010/hydeGoes_scSeq_mdd/MDD_vs_BP/twas/FUSION.profile_wgt.R ", wglist, " > ", opt$region, "_", opt$feature, ".profile.err 2>&1"))

#system(paste0("Rscript /jhpce/shared/libd/core/fusion_twas/github/fusion_twas-master/utils/FUSION.profile_wgt.R ", wglist, " > ", opt$region, "_", opt$feature, ".profile.err 2>&1"))
