...
#SBATCH -p shared
#SBATCH --mem=50G
#SBATCH --job-name=3_compute_weights_indv_Amygdala_full_gene_5
#SBATCH -c 1
#SBATCH -o logs/Amygdala_gene/compute_weights_indv_Amygdala_full_gene_5_%a_O.txt
#SBATCH -e logs/Amygdala_gene/compute_weights_indv_Amygdala_full_gene_5_%a_E.txt
