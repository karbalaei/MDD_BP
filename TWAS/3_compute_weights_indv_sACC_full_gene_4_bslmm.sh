...
#SBATCH -p shared
#SBATCH --mem=20G
#SBATCH --job-name=3_compute_weights_indv_sACC_full_gene_4_bslmm
#SBATCH -c 1
#SBATCH -o logs/sACC_gene/compute_weights_indv_sACC_full_gene_4_%a_O_bslmm.txt
#SBATCH -e logs/sACC_gene/compute_weights_indv_sACC_full_gene_4_%a_E_bslmm.txt
...
FILELIST=$(echo "/dcs04/lieber/lcolladotor/hydeGoes_LIBD3010/hydeGoes_scSeq_mdd/MDD_vs_BP/twas/sACC_gene/input_ids_4.txt")
