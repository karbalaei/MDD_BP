...
#SBATCH -p shared
#SBATCH --mem=50G
#SBATCH --job-name=twas_compute_weights_indv_sACC_full_gene_5
#SBATCH -c 1
#SBATCH -o logs/sACC_gene/compute_weights_indv_sACC_full_gene_5_%a_O.txt
#SBATCH -e logs/sACC_gene/compute_weights_indv_sACC_full_gene_5_%a_E.txt
...
FILELIST=$(echo "/dcs04/lieber/lcolladotor/hydeGoes_LIBD3010/hydeGoes_scSeq_mdd/MDD_vs_BP/twas/sACC_gene/input_ids_5.txt")
