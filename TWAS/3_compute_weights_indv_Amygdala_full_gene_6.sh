...
#SBATCH -p shared
#SBATCH --mem=50G
#SBATCH --job-name=twas_compute_weights_indv_Amygdala_full_gene_6
#SBATCH -c 1
#SBATCH -o logs/Amygdala_gene/compute_weights_indv_Amygdala_full_gene_6_%a_O.txt
#SBATCH -e logs/Amygdala_gene/compute_weights_indv_Amygdala_full_gene_6_%a_E.txt
...
FILELIST=$(echo "/dcs04/lieber/lcolladotor/hydeGoes_LIBD3010/hydeGoes_scSeq_mdd/MDD_vs_BP/twas/Amygdala_gene/input_ids_6.txt")
