...
#SBATCH -p shared
#SBATCH --mem=20G
#SBATCH --job-name=3_compute_weights_indv_Amygdala_full_gene_2_bslmm
#SBATCH -c 1
#SBATCH -o logs/Amygdala_gene/compute_weights_indv_Amygdala_full_gene_2_%a_O_bslmm.txt
#SBATCH -e logs/Amygdala_gene/compute_weights_indv_Amygdala_full_gene_2_%a_E_bslmm.txt
...
FILELIST=$(echo "/dcs04/lieber/lcolladotor/hydeGoes_LIBD3010/hydeGoes_scSeq_mdd/MDD_vs_BP/twas/Amygdala_gene/input_ids_2.txt")
