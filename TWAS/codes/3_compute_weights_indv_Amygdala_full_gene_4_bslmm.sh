...
#SBATCH -p shared
#SBATCH --mem=20G
#SBATCH --job-name=3_compute_weights_indv_Amygdala_full_gene_4_bslmm
#SBATCH -c 1
#SBATCH -o logs/Amygdala_gene/compute_weights_indv_Amygdala_full_gene_4_%a_O_bslmm.txt
#SBATCH -e logs/Amygdala_gene/compute_weights_indv_Amygdala_full_gene_4_%a_E_bslmm.txt
