...
#SBATCH -p shared
#SBATCH --mem=20G
#SBATCH --job-name=3_compute_weights_indv_sACC_full_gene_6_bslmm
#SBATCH -c 1
#SBATCH -o logs/sACC_gene/compute_weights_indv_sACC_full_gene_6_%a_O_bslmm.txt
#SBATCH -e logs/sACC_gene/compute_weights_indv_sACC_full_gene_6_%a_E_bslmm.txt
