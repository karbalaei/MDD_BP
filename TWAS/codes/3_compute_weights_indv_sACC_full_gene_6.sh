...
#SBATCH -p shared
#SBATCH --mem=50G
#SBATCH --job-name=twas_compute_weights_indv_sACC_full_gene_6
#SBATCH -c 1
#SBATCH -o logs/sACC_gene/compute_weights_indv_sACC_full_gene_6_%a_O.txt
#SBATCH -e logs/sACC_gene/compute_weights_indv_sACC_full_gene_6_%a_E.txt
#SBATCH --mail-type=ALL
#SBATCH --array=1-2585%55
...
FILELIST=$(echo "/dcs04/lieber/lcolladotor/hydeGoes_LIBD3010/hydeGoes_scSeq_mdd/MDD_vs_BP/twas/sACC_gene/input_ids_6.txt")
...
# Print the results (you can also save them to a file or process further)
#echo "FEATURENUM: $FEATURENUM"
...
#Rscript /dcs04/lieber/lcolladotor/hydeGoes_LIBD3010/hydeGoes_scSeq_mdd/MDD_vs_BP/codes/FUSION.compute_weights.R \
