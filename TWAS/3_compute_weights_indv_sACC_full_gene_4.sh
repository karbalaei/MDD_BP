...
#SBATCH -p shared
#SBATCH --mem=50G
#SBATCH --job-name=twas_compute_weights_indv_sACC_full_gene_4
#SBATCH -c 1
#SBATCH -o logs/sACC_gene/compute_weights_indv_sACC_full_gene_4_%a_O.txt
#SBATCH -e logs/sACC_gene/compute_weights_indv_sACC_full_gene_4_%a_E.txt
