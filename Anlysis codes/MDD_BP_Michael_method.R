...
BP_MDD_Gene_Final<- map2(rse_gene_sep, modSep, ~run_DE(rse = .x, model = .y, save_eBayes = TRUE))

save(BP_MDD_Gene_Final, file = here("results" , "BP_MDD_Gene_Micheal_method_Final.Rdata"), compress=TRUE)
...
BP_MDD_Exon_Final<- map2(rse_sep_exon, modSep, ~run_DE(rse = .x, model = .y, save_eBayes = TRUE))
save(BP_MDD_Exon_Final, compress = TRUE, file = here("results" , "BP_MDD_Exon_Micheal_method_Final.Rdata"))
...
BP_MDD_Junction_Final<- map2(rse_sep_jxn, modSep, ~run_DE(rse = .x, model = .y, save_eBayes = TRUE))
save(BP_MDD_Junction_Final, file = here("results" ,"BP_MDD_Junction_Micheal_method_Final.Rdata"))
...
BP_MDD_Transcript_Final<- map2(rse_sep_tx, modSep, ~run_DE(.x, .y, run_voom = FALSE, save_eBayes = TRUE))
save(BP_MDD_Transcript_Final, compress=TRUE, file = here("results" ,"BP_MDD_Transcript_Micheal_method_Final.Rdata"))
...
Outlist <-  list("gene" = BP_MDD_Gene_Final, "exon" = BP_MDD_Exon_Final, "jxn" = BP_MDD_Junction_Final ,"tx" = BP_MDD_Transcript_Final)


save(Outlist , file = here("results", "BP_MDD_All_results_Micheal_method_Final.RDS"))
