...
save(BP_MDD_Gene_Final, file = here("results" , "BP_MDD_Gene_qSV.Rdata"), compress=TRUE)
...
save(BP_MDD_Exon_Final, compress = TRUE, file = here("results" , "BP_MDD_Exon_qSV.Rdata"))
...
save(BP_MDD_Junction_Final, file = here("results" ,"BP_MDD_Junction_qSV.Rdata"))
...
save(BP_MDD_Transcript_Final, compress=TRUE, file = here("results" ,"BP_MDD_Transcript_qSV.Rdata"))
...
save(Outlist , file = here("results", "BP_MDD_All_results.RDS"))
