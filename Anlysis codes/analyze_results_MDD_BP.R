...
pdf(here("graphs" , "wgcna" ,"prop.table vs MDDEffect Amygdala.pdf"),w=9,h=6, useDingbats = FALSE)
...
pdf(here("graphs" , "wgcna" ,"-log10Pvalue chi-sq vs MDDEffect Amygdala.pdf"),w=9,h=6, useDingbats = FALSE)

plot(-log10(deModEnrich$Pvalue), -log10(MDDEffect$pvalue ))

dev.off()

write.table(deModEnrich , file = here("graphs" , "wgcna" , "deModEnrich_Amygdala_table.csv" ) , sep = "," )
...
pdf(here("graphs" , "wgcna" ,"prop.table vs MDDEffect sACC.pdf"),w=9,h=6, useDingbats = FALSE)
...
pdf(here("graphs" , "wgcna" ,"-log10Pvalue chi-sq vs MDDEffect sACC.pdf"),w=9,h=6, useDingbats = FALSE)

plot(-log10(deModEnrich$Pvalue), -log10(MDDEffect$pvalue ))

dev.off()

write.table(deModEnrich , file = here("graphs" , "wgcna" , "deModEnrich_sACC_table.csv" ) , sep = "," )
